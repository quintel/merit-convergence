...
DE_ARCHIVE = Merit::Convergence::Archive.new(
  DATA_DIR.join('/Users/kruip/Projects/etengine/tmp/convergence/20150223_1032/DE_369381_2015-02-23_13-53-53'),
  DATASETS_DIR.join('de/load_profiles')  # Path to the DE load profiles.
)

NL_ARCHIVE = Merit::Convergence::Archive.new(
  DATA_DIR.join('/Users/kruip/Projects/etengine/tmp/convergence/20150223_1032/NL_369379_2015-02-23_13-54-25'),                   # Path to the NL data.
...
headers = ['Key', 'Marginal_Cost_(EUR/MWh)', 'Available Capacity_(MW)', '%_Price-setting']
...
# headers = ['Key', 'Marginal_Cost_(EUR/MWh)', 'Installed Capacity_(MW)', '%_Price-setting']
...
# File.write('price_setting_producers_2.csv', price_content)