...
DE_ARCHIVE = Merit::Convergence::Archive.new(
  DATA_DIR.join('/Users/kruip/Projects/etengine/tmp/convergence/20140924_1535/DE_369381_2014-09-24_15-37-53'),
  DATASETS_DIR.join('de/load_profiles')  # Path to the DE load profiles.
)

NL_ARCHIVE = Merit::Convergence::Archive.new(
  DATA_DIR.join('/Users/kruip/Projects/etengine/tmp/convergence/20140924_1535/NL_373853_2014-09-24_17-54-20'),                   # Path to the NL data.
